...
from library.model.abstract_recommender import KnowledgeRecommender
from library.model.init import xavier_normal_initialization
from library.model.loss import EmbLoss
from library.utils import InputType
...
class KGCN(KnowledgeRecommender):
    ...
    associated attributes on the KG."""
