...
from library.data.dataset import KGSeqDataset, SequentialDataset
from library.data.interaction import Interaction
from library.sampler import SeqSampler
from library.utils.enum_type import FeatureType
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~library.data.dataset.sequential_dataset.SequentialDataset`.
    ...
    Attributes:
        augmentation (bool): Whether the interactions should be augmented.
        seq_sample: A sampler used to sample negative item sequence.
