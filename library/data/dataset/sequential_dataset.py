...
from library.data.dataset import Dataset
from library.data.interaction import Interaction
from library.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~library.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~library.config.eval_setting.EvalSetting`):
