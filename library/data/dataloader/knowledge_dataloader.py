...
from library.data.dataloader.abstract_dataloader import AbstractDataLoader
from library.data.dataloader.general_dataloader import TrainDataLoader
from library.data.interaction import Interaction
from library.utils import InputType, KGDataLoaderState
import numpy as np
...
class KnowledgeBasedDataLoader:
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~library.data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                - :obj:`~library.utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~library.utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~library.utils.enum_type.KGDataLoaderState.RSKG`
