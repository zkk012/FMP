...
from library.utils import InputType, FeatureType, FeatureSource, ModelType
from library.data.transform import construct_transform
...
class AbstractDataLoader(torch.utils.data.DataLoader):
    ...
    :class:`~library.data.interaction.Interaction` when it is iterated.
